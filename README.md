...
|---|---|---|---|
| Layer 1: Memory | [Spec](spec/layer1-memory.md) | [8 tests](conformance/layer1/) | [AMH v1.0](https://github.com/MakiDevelop/agent-memory-hall) |
| Layer 2: Trust | [Spec](spec/layer2-trust.md) | [5 tests](conformance/layer2/) | AMH v1.0 |
| Layer 3: Identity | [Spec](spec/layer3-identity.md) | [6 tests](conformance/layer3/) | AMH v1.0 |
| Layer 4: Authority | [Spec](spec/layer4-authority.md) | [6 tests](conformance/layer4/) | AMH v1.0 |
| Layer 5: Decision | [Spec](spec/layer5-decision.md) | [5 tests](conformance/layer5/) | AMH v1.0 |
| Governance Plane | [Spec](spec/governance-plane.md) | [4 tests](conformance/governance/) | AMH v1.0 |

## Quick Start

```bash
# Try the reference implementation (full stack: L1-5 + Governance Plane)
